...
function BoxLarge(props) {
    ...
    if(window.innerWidth <= mobile_size){
        ...
        return(
            ...
            <BoxLarge_Mobile scrollHeight={props.mobile_scroll_height}  content={props.content} />
        ...
        return(
            ...
            <BoxLarge_Desktop scrollHeight={props.desktop_scroll_height} content={props.content} />
